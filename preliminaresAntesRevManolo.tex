atributos estrechamente relacionado con\pagestyle{empty}
...
Este concepto de implicación es el que guía este trabajo otorgando un gran potencial para automatizar técnicas de razonamiento, con el beneficio que eso conlleva. Además, las implicaciones son elemento fundamental para el desarrollo de formas más eficientes que el retículo de conceptos de representación del conocimiento. 
...
Basándose en el Teorema de Deducción y las equivalencias anteriores, en \cite{Mora2012}, los autores presentan un novedoso algoritmo para calcular cierres utilizando \slfd, denominado {\tt Cls}\index{Cierre \slfd} que actúa según el siguiente procedimiento.
