...
\begin{figure}[htbp]
		...
		\end{center}
		\caption{Retículo de conceptos\index{retículo de concepto} asociado al contexto formal \ref{ejemploContextoFormal}}
...
\begin{definicion}[Dependencia Funcional]\index{Dependencia Funcional}
