...
\let\cleardoublepage\clearpage
%\include{parteGeneradoresMinimales}
\includepdf[pages=-,scale=.9,pagecommand={}]{paperClavesMinimales.pdf}
\clearemptydoublepage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Sistemas de Recomendación Conversacionales}
\label{cap:sistemasRecomendacion}
\let\cleardoublepage\clearpage
%\include{parteSistemasRecomendacion}
\includepdf[pages=-,scale=.8,pagecommand={}]{paperSistemaRecomendacionConversacional.pdf}
\clearemptydoublepage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
