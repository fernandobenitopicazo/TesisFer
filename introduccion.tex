...
% con el paralelo
Una propiedad muy interesante de los métodos basados en Tableaux es la generación de subproblemas independientes los unos de los otros a partir del problema original. De esta forma, se alcanza el objetivo fundamental de esta tesis de utilizar las técnicas lógicas sobre una implementación paralela de los métodos que, mediante el uso de recursos de supercomputación, permitan alcanzar resultados en un tiempo razonable.
